...
public class newsClassification {
    ...
    public newsClassification(String fileName, int labelCount) throws IOException {
...
//            System.out.println("TEST: "+testLabelType+" PREDICTION: "+index);
    ...
    public static  void main(String[] args) throws IOException {
        ...
        newsClassification nf = new newsClassification("/Users/Sam/AI_MP/MP3/spam_detection/train_email.txt",2);
        ...
        nf = new newsClassification("/Users/Sam/AI_MP/MP3/8category/8category.training.txt",8);
